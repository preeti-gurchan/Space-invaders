...
# Player player
YELLOW_SPACE_SHIP = pygame.image.load(os.path.join("Assets", "ship_yellow_player.png"))
...
YELLOW_LASER = pygame.image.load(os.path.join("Assets", "laser_yellow_player.png"))
